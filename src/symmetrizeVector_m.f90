module symmetrizeVector_m

    implicit none

    public :: symmetrizeVector
...
subroutine symmetrizeVector(n_symm_op, symm_op, tol, vector, debug)
    ...
    do io = 1, n_symm_op
        ...
        if(debug) then
            ...
            write(6,'(a)') "symmetrizeVector: Projected vector"
            write(6,'(3f16.9)') projected_vector(1:3)
        endif
        if( &
