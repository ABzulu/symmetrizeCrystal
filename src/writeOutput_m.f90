    ...
    do ix = 1, 3
        do jx = 1, 3
            temp_lattice_vector(ix,jx) = &
                T(1,ix)*reduced_lattice_vectors(1,jx) + &
                T(2,ix)*reduced_lattice_vectors(2,jx) + &
                T(3,ix)*reduced_lattice_vectors(3,jx)
        enddo
    enddo
        ...
        do ia = 1, n_atom
            ...
            do i = 1, 3
                temp_atomic_coordinates(i,ia) = &
                    temp_lattice_vector(1,i) * temp_a(1) + &
                    temp_lattice_vector(2,i) * temp_a(2) + &
                    temp_lattice_vector(3,i) * temp_a(3)
            enddo
        enddo
